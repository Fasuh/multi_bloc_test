...
CustomTextStyle get roboto => Roboto();
...
class CustomTextStyle extends TextStyle {
  ...
  CustomTextStyle get colorBlueButton => copyWith(color: buttonBlueColor);

  CustomTextStyle get colorPrimary => copyWith(color: primaryColor);

  CustomTextStyle get colorBlack => copyWith(color: blackColor);

  CustomTextStyle get colorAccent => copyWith(color: accentColor);
