...
extension conversionExt on String {
  double toDoubleIncludingInt() {
    return (double.parse(this, (source) => int.tryParse(source)?.toDouble()) ?? 0);
  }
}
...
extension LinearGradientExtension on LinearGradient {
  LinearGradient copyWith({
    ...
    return LinearGradient(begin: begin, end: end, colors: this.colors, stops: this.stops, tileMode: this.tileMode);
  }
